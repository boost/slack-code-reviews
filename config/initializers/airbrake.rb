...
# Rails applications. In doing so, it allows you to easily review errors,
# tie an error to an individual piece of code, and trace the cause back to
# recent changes. Airbrake enables for easy categorization, searching, and
